  ...
  <div id="user-edit-tab-info">
    ...
    <div class="vx-row">
      <div class="vx-col w-full">
        <div class="flex items-start flex-col sm:flex-row">
          ...
          <div>
            <p class="text-lg font-medium mb-2 mt-4 sm:mt-0">{{ role_data.name }}</p>
    ...
    <div class="vx-row">
      <div class="vx-col md:w-1/2 w-full">
        ...
        <vs-input class="w-full mt-4" label="Name" v-model="role_data[`name`]" v-validate="'required|alpha_spaces'" name="name" />
...
export default {
  ...
  methods: {
    submit(){
      ...
      this.$store.dispatch(`ADD_ROLE`,payload).then(response=>{
